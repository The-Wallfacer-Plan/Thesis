...
of a target program. Procedure \emph{cov\_new\_trace} in Algo.~\ref{algo:gbf} is to check whether a value has already been contained in the set.
...
\begin{figure}[t]
	...
	\begin{subfigure}[b]{.38\columnwidth}
		\centering{\includegraphics[width=.8\linewidth]{res/mtfuzz/callgraph.pdf}}
\caption{}\label{subfig:callgraph}
	\end{subfigure}\begin{subfigure}[b]{0.61\linewidth}
		\centering{\includegraphics[width=.75\linewidth]{res/mtfuzz/transitions.pdf}}
...
As seen in Algo.~\ref{algo:gbf}, for a mutated seed, a GBF typically executes the target program with multiple times. 
...
with 5 proof-of-crash generated seeds; while AFL or \mtfuzzc cannot detect this crash. 
